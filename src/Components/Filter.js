...
class Filter extends React.Component {
  ...
  handleSortChange = (sort) => {
    const { location, mealTypeId, lcost, hcost, cuisine } = this.state;
    const obj = {
      lCost: lcost,
      hCost: hcost,
      sort: sort,
  ...
  handleCostChange = (lcost, hcost) => {
    const { location, mealTypeId, sort, cuisine } = this.state;
    const obj = {
      lCost: lcost,
      hCost: hcost,
      sort: sort,
    ...
    axios({
      ...
      .then((response) =>
        this.setState({ resturants: response.data.resturant, lcost, hcost })
      )
      .catch();
  };
  ...
  handleLocationChange = (event) => {
    ...
    const { mealTypeId, sort, lcost, hcost, cuisine } = this.state;
    const obj = {
      lCost: lcost,
      hCost: hcost,
      sort: sort,
    ...
    axios({
      ...
      .then((response) =>
        this.setState({ resturants: response.data.resturant, location })
      )
      .catch();
  };
  ...
  handlePage = (pagination) => {
    ...
    axios({
      ...
      .then((response) =>
        this.setState({ resturants: response.data.resturant, pagination })
      )
      .catch();
  };

  handleCuisineChange = (cuisineId) => {
    const { location, mealTypeId, sort, cuisine, lcost, hcost } = this.state;
            ...
            <div class="col-sm-4 col-md-4 col-lg-4">
              <div class="Filterrectangle">
                ...
                <div>
                  ...
                  >
                    <option style={{ color: "#8c96ab" }} value="0">
                      Select
                    </option>
                    {locations.map((item) => {
                      return (
                ...
                <div>
                  <input
                    ...
                    name="costSort"
                    onChange={() => {
                      this.handleCostChange(500, 1000);
                    }}
                  />
                ...
                <div>
                  <input
                    ...
                    name="costSort"
                    onChange={() => {
                      this.handleCostChange(1000, 1500);
                    }}
                  />
                ...
                <div>
                  <input
                    ...
                    name="costSort"
                    onChange={() => {
                      this.handleCostChange(1500, 2000);
                    }}
                  />
                ...
                <div>
                  <input
                    ...
                    name="costSort"
                    onChange={() => {
                      this.handleCostChange(2000, 10000);
                    }}
                  />
