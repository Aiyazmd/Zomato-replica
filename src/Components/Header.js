...
class Header extends React.Component {
  ...
  componentDidMount() {
    ...
    if (credit)
      this.setState({
        userName: credit,
        isLogged: true,
        email: localStorage.getItem("creditEmail"),
      });
  }
  ...
  handleloginvalid = () => {
    const { email, loginData, password } = this.state;
    let createData;
    const obj = {
      email: email,
    };
  ...
  render() {
    ...
    return (
      <div class="app_header">
        <button class="headerE" onClick={this.handleHome}>
          e!
        </button>
        {isLogged ? (
          <div>
        ...
        <Modal isOpen={loginModalIsOpen} style={secondStyles}>
          <div>
